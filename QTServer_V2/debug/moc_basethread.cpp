...
QT_MOC_LITERAL(1, 11, 11), // "sendSignals"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "Message&"
QT_MOC_LITERAL(4, 33, 3) // "msg"

    },
    "BaseThread\0sendSignals\0\0Message&\0msg"
};
...
void BaseThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSignals((*reinterpret_cast< Message(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BaseThread::*)(Message & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseThread::sendSignals)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BaseThread::sendSignals(Message & _t1)
{
